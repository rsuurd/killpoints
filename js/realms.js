const REALMS = {
  ...
  "us": ["Aegwynn", "Aerie Peak", "Agamaggan", "Aggramar", "Akama", "Alexstrasza", "Alleria", "Altar of Storms", "Alterac Mountains",
   ...
   "kr": ["렉사르", "불타는 군단", "와일드해머", "가로나", "달라란", "데스윙", "라그나로스", "말퓨리온", "세나리우스", "알렉스트라자", "카르가스",
          "하이잘", "헬스크림", "스톰레이지", "윈드러너", "굴단", "노르간논", "듀로탄", "아즈샤라",  "에이그윈",  "엘룬", "이오나", "줄진"],
   "tw": ["狼狂索斯", "世界之樹", "暗影之月", "天空之牆", "巴納札爾", "巨龍之喉", "狂熱之刃", "冬握湖", "雷鱗", "凜風峽灣", "米奈希爾",
          "死亡之翼", "水晶之刺", "艾奧那斯", "遠祖灘頭", "日落沼澤", "戰歌", "提克迪奧斯", "地獄吼", "尖石", "風暴群山", "火焰之樹",
          "冰霜之刺", "冰風崗哨", "聖光之願", "亞雷戈斯", "語風", "奧妮克希亞", "暴風祭壇", "眾星之子", "科爾蘇加德", "狂心", "鬼霧峰",
          "奎爾達納斯", "奈辛瓦里", "屠魔山谷", "諾姆瑞根", "憤怒使者", "撒爾薩里安", "阿薩斯", "夜空之歌", "惡魔之魂", "銀翼要塞",
          "寒冰皇冠", "血之谷", "黑龍軍團"]
};
